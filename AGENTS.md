...
## Identidade
- **Projeto:** ferramenta educacional gratuita de análise preliminar de risco AML/KYC, Privacy by Design, 100% no navegador.
- **Repo:** sem git nesta pasta (não catalogado em `../projetos.json`) — se for publicar, crie o repo primeiro.
- **Stack:** estático client-side (pensado para GitHub Pages).
- **Aviso obrigatório:** finalidade exclusivamente educacional; não substitui análise jurídica/regulatória — manter esse disclaimer em qualquer mudança.
